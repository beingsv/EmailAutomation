...
export default function ATSScorerPage() {
  ...
  if (isCheckingResume) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">ATS Compatibility Scorer</h1>
          <p className="mt-1 text-gray-500">Check how well your resume matches a job description.</p>
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-yellow-800 bg-yellow-900/20 p-6 text-center">
          ...
          <Link
            href="/resume"
            className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-gray-900 transition-colors hover:bg-blue-700"
          >
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Form Section */}
      <div className="rounded-2xl bg-white/80 backdrop-blur-xl border border-gray-200/60 shadow-lg shadow-gray-200/60 p-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="mt-2 text-sm font-medium text-blue-600 hover:text-blue-300 transition-colors"
              >
                Try again
              </button>
            </div>
      ...
      {/* Loading state */}
      {isAnalyzing && (
        <div className="rounded-2xl bg-white/80 backdrop-blur-xl border border-gray-200/60 shadow-lg shadow-gray-200/60 p-8">
          <div className="flex flex-col items-center justify-center text-center">
            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-blue-500 mb-4" />
            <p className="text-sm text-gray-500">Analyzing your resume against the job description...</p>
      ...
      {!isAnalyzing && result && (
        <div className="space-y-6">
          ...
          <div className="rounded-2xl bg-white/80 backdrop-blur-xl border border-gray-200/60 shadow-lg shadow-gray-200/60 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4 text-center">Overall Score</h2>
            <ScoreDisplay
