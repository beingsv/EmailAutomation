  ...
  if (isCheckingResume) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Interview Preparation</h1>
          <p className="mt-1 text-gray-500">Generate tailored interview questions and preparation tips.</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl bg-white/80 backdrop-blur-xl border border-gray-200/60 shadow-lg shadow-gray-200/60 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Preparation Tips</h2>
            </div>
